            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">help@elite8digital.in</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">+6260894977</p>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  ...
                  <a href="https://www.linkedin.com/company/elite8-digital/about/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center hover:bg-primary/20 transition-colors">
